...
const softCopyTeas = popularTeas.slice();
popularTeas.push("matcha");
console.log(popularTeas); // Output: ["green tea", "oolong tea", "chai", "matcha"]
...
console.log(topCities); // Output: ["Berlin", "Singapore", "New York", "Tokyo"]
console.log(hardCopyCities); // Output: ["Berlin", "Singapore", "New York", "Tokyo"]
console.log(topCities === hardCopyCities); // Output: true
